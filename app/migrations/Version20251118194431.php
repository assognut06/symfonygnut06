 ...
 */
final class Version20251118194431 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE asso_recommander ADD meta_created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD meta_updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE banner banner VARCHAR(500) DEFAULT NULL, CHANGE type type VARCHAR(100) DEFAULT NULL, CHANGE category category VARCHAR(100) DEFAULT NULL, CHANGE logo logo VARCHAR(500) DEFAULT NULL, CHANGE city city VARCHAR(100) DEFAULT NULL, CHANGE zip_code zip_code VARCHAR(10) DEFAULT NULL, CHANGE url url VARCHAR(500) DEFAULT NULL, CHANGE created_at created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_A88B930CA194A5FF ON asso_recommander (organization_slug)');
        $this->addSql('CREATE INDEX idx_organization_slug ON asso_recommander (organization_slug)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_A88B930CA194A5FF ON asso_recommander');
        $this->addSql('DROP INDEX idx_organization_slug ON asso_recommander');
        ...
        $this->addSql('ALTER TABLE asso_recommander DROP meta_created_at, DROP meta_updated_at, CHANGE banner banner VARCHAR(255) DEFAULT NULL, CHANGE type type VARCHAR(255) DEFAULT NULL, CHANGE category category VARCHAR(255) DEFAULT NULL, CHANGE logo logo VARCHAR(255) DEFAULT NULL, CHANGE city city VARCHAR(255) DEFAULT NULL, CHANGE zip_code zip_code VARCHAR(255) DEFAULT NULL, CHANGE url url VARCHAR(255) DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    }
}
