...
class AdminBenevoleController extends AbstractController
{
    ...
    #[Route('/new', name: 'benevole_new')] public function new(Request $request, EntityManagerInterface $em): Response 
    {
    ...
    #[Route('/edit/{id}', name: 'benevole_edit')] 
    public function edit(Benevole $benevole, Request $request, EntityManagerInterface $em): Response 
    {
        $form = $this->createForm(BenevoleType::class, $benevole); $form->handleRequest($request);
