...
- When a user asks an agent to create a branch and does not provide all required parts, ask for:
  - the branch type, reminding them that possible values are `feature`, `fix`, and `hotfix`;
  - the Taiga ticket number;
